(function () { // Input 0
    ...
    */
    ...
    goog.loadModule = function (a) {
        ...
        try {
            ...
            if ("string" === typeof e && e) {
                goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(e, d, c !== d) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof d && null != d && Object.seal(d), goog.loadedModules_[e] = {
                    exports: d,
                    type: goog.ModuleType.GOOG,
    ...
    var validCommerceEvents = ["purchase"],
        ...
        validateCommerceDataKeys = function (a) {
            var b = "sku name price quantity brand category variant".split(" "),
                c = utils.calculateDiffBetweenArrays("common type transaction_id currency revenue revenue_in_usd exchange_rate shipping tax coupon affiliation persona products".split(" "), Object.keys(a));
            if (c.length) {
    ...
    utils.separateEventAndCustomData = function (a) {
        ...
        return {
            custom_data: utils.convertObjectValuesToString(c),
            event_data: a
        };
    };
    ...
    resources.linkClick = {
        ...
        method: utils.httpMethod.GET,
        queryPart: {
            link_url: validator(!0, validationTypes.STRING)
        },
        params: {
            click: validator(!0, validationTypes.STRING)
        }
    };
    ...
    resources.deepview = {
        ...
        params: defaults({
            ...
            append_deeplink_path: validator(!1,
                validationTypes.BOOLEAN),
            stage: validator(!1, validationTypes.STRING),
            tags: validator(!1, validationTypes.ARRAY),
    ...
    Server.prototype.jsonpRequest = function (a, b, c, d) {
        ...
        var g = "branch_callback__" + this._jsonp_callback_index++,
            k = 0 <= a.indexOf("branch.io") ? "&data=" : "&post_data=";
    ...
    Server.prototype.request = function (a, b, c, d) {
        ...
        f = this.getUrl(a, b);
        if (f.error) {
            return d(Error(safejson.stringify({
                message: f.error,
                endpoint: a.endpoint,
                data: b
            })));
    ...
    var banner_utils = {
        ...
        addCSSLengths: function (a, b) {
            var c = function (d) {
                ...
                d = d.match(/\d+/g);
                var f = parseInt(0 < d.length ? d[0] : "0", 10),
                    g = function () {
    ...
    var banner_css = {
        ...
        ios: "",
        android: "#branch-banner #branch-banner-close,#branch-banner .theme-dark #branch-banner-close { height:17px; width: 17px; text-align: center; font-size: 15px; top: 24px;  border-radius:14px; border:0; line-height:14px; color:#b1b1b3; background:#efefef; padding: 0; opacity: 1; }\n#branch-banner .button { top: 0; text-decoration:none; border-bottom: 3px solid #A4C639; padding: 0 10px; height: 24px; line-height: 24px; text-align: center; color: #fff; margin-top: 2px;  font-weight: bold; background-color: #A4C639; border-radius: 5px; }\n#branch-banner .button:hover { border-bottom:3px solid #8c9c29; background-color: #c1d739; }\n",
        blackberry: "",
        windows_phone: "",
        kindle: ""
    };
    ...
    var sendSMS = function (a, b, c, d) {
            var e = a.getElementById("branch-sms-phone"),
                ...
                k = a.getElementById("branch-sms-form-container"),
                h, l = function () {
        ...
        banner = function (a, b, c, d) {
            ...
            var e, f = document.body.style.marginTop,
                g = document.body.style.marginBottom,
                k = function (h, l) {
    ...
    journeys_utils.addIframeOuterCSS = function (a, b) {
        ...
        var e = +journeys_utils.bodyMarginBottom.slice(0, -2),
            f = +journeys_utils.bannerHeight.slice(0, -2);
    ...
    journeys_utils.setJourneyLinkData = function (a) {
        var b = {
            banner_id: journeys_utils.branchViewId
        };
    ...
    branch_view.displayJourney = function (a, b, c, d, e, f) {
        if (!journeys_utils.exitAnimationIsRunning) {
            ...
            var h = !1,
                l = b.callback_string,
                m = null,
                p = journeys_utils.branch._storage;
            if (a) {
    ...
    branch_view._getPageviewRequestData = function (a, b, c, d) {
        ...
        var e = utils.merge({}, c._branchViewData),
            ...
            l = (b.user_language || utils.getBrowserLanguageCode() || "en").toLowerCase() || null,
            m = utils.getInitialReferrer(c._referringLink()),
    ...
    // Input 16
    var default_branch, callback_params = {
            NO_CALLBACK: 0,
            CALLBACK_ERR: 1,
            CALLBACK_ERR_DATA: 2
        },
    ...
    Branch.prototype.init = wrap(callback_params.CALLBACK_ERR_DATA, function (a, b, c) {
        ...
        var f = c && "undefined" !== typeof c.branch_match_id && null !== c.branch_match_id ? c.branch_match_id : null,
            g = f || utils.getParamValue("_branch_match_id") || utils.hashValue("r"),
            k = !d.identity_id;
        ...
        var h = function (n) {
                var r = {
                    ...
                    t = session.get(d._storage) || {},
                    u = session.get(d._storage, !0) || {};
        ...
        if (b && b.session_id && !g && !utils.getParamValue("branchify_url")) {
            ...
            utils.isSafari11OrGreater() || utils.isIOSWKWebView() ? utils.delay(function () {
                d._api(resources.open, {
                    link_identifier: g,
                    browser_fingerprint_id: g || q.browser_fingerprint_id,
    ...
    Branch.prototype.crossPlatformIds = wrap(callback_params.CALLBACK_ERR_DATA, function (a) {
        this._api(resources.crossPlatformIds, {
    ...
    Branch.prototype.lastAttributedTouchData = wrap(callback_params.CALLBACK_ERR_DATA, function (a, b) {
        ...
        this._api(resources.lastAttributedTouchData, {
    ...
    Branch.prototype.banner = wrap(callback_params.CALLBACK_ERR, function (a, b, c) {
        ...
        var d = {
            ...
            reviewCount: "number" === typeof b.reviewCount && 0 < b.reviewCount ? Math.floor(b.reviewCount) : null,
            rating: "number" === typeof b.rating && 5 >= b.rating && 0 < b.rating ? Math.round(2 * b.rating) / 2 : null,
            openAppButtonText: utils.cleanBannerText(b.openAppButtonText) || "View in app",
            downloadAppButtonText: utils.cleanBannerText(b.downloadAppButtonText) ||
                "Download App",
            sendLinkText: utils.cleanBannerText(b.sendLinkText) || "Send Link",
            phonePreviewText: utils.cleanBannerText(b.phonePreviewText) || "(999) 999-9999",
            ...
            showBlackberry: "undefined" === typeof b.showBlackberry ? !0 : b.showBlackberry,
            showWindowsPhone: "undefined" ===
                typeof b.showWindowsPhone ? !0 : b.showWindowsPhone,
            ...
            forgetHide: "number" === typeof b.forgetHide ? b.forgetHide : !!b.forgetHide,
            respectDNT: "undefined" === typeof b.respectDNT ? !1 : b.respectDNT,
            position: b.position || "top",
            customCSS: b.customCSS || "",
            mobileSticky: "undefined" === typeof b.mobileSticky ? !1 : b.mobileSticky,
            desktopSticky: "undefined" === typeof b.desktopSticky ? !0 : b.desktopSticky,
    ...
    Branch.prototype.trackCommerceEvent = wrap(callback_params.CALLBACK_ERR, function (a, b, c, d) {
        ...
        e.renderQueue(function () {
            ...
            e._api(resources.commerceEvent, {
                event: b,
                metadata: utils.merge({
                    url: document.URL,
                    user_agent: navigator.userAgent,
